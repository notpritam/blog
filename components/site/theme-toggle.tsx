...
export function ThemeToggle() {
  ...
  return (
    <button type="button" onClick={toggle} aria-label={theme === 'dark' ? 'Switch to light theme' : 'Switch to dark theme'} title={theme === 'dark' ? 'Light mode' : 'Dark mode'} className="site-icon-link">
      {theme === 'dark' ? (
